Vue.component('todo-item',{
	props: ['item'],
	template: 
	`<li class="list-group-item" v-bind:style="isActive">{{ item.name }}
		<button type="button" class="btn btn-success  btn-sm float-right" v-on:click="toggleTodo">
			<i class="fas fa-check"></i>
		</button>
		<button type="button" class="btn btn-danger btn-sm float-right" aria-label="Close" v-on:click="deleteTodo">
